...
ml_dataset = pickle.load(
    open(os.path.join(dump_dir, 'ml-20m-first-10000'), 'rb'))
...
alpha = 0.02
eta = 0.02
dump_info = 'ml-unb-glo-005lr-10parts'
...
# perf6 = evaluate_parts(algo6, dataset=ml_dataset, measures=[
#                        'RMSE', 'MAE'], trainset_parts=10, with_dump=True, dump_info=dump_info)

# perf7 = evaluate_parts(algo7, dataset=lt_dataset, aux_dataset=lt_dataset, measures=[
#                        'RMSE', 'MAE'], trainset_parts=10, with_dump=True, dump_info=dump_info)
