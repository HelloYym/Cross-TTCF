...
from .prediction_algorithms import SVD, UserItemTags, UserItemGenomeTags, ItemRelTags
...
__all__ = ['AlgoBase', 'NormalPredictor', 'BaselineOnly', 'KNNBasic',
           ...
           'dump', 'SymmetricAlgo', 'RatingsReader', 'TagsReader', 'UserItemTags', 'UserItemGenomeTags', 'ItemRelTags']
